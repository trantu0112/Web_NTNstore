<div class="modal fade" id="md_addcart_nike" role="dialog" aria-hidden="true">
...
<div class="ps-section--features-product ps-section masonry-root pt-50 pb-80">
  ...
  <div class="ps-section__header mb-50">
    <h3 class="ps-section__title" data-mask="NIKE" style="font-size: 40px; color: #2AC37D;">- NIKE</h3>
  </div>
  ...
  <div class="ps-product-action">
      <div class="ps-product__filter">
          <select class="ps-select selectpicker" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
              ...
              <option value="nike/1/asc">GÍA TĂNG DẦN</option>
              <option value="nike/1/desc">GÍA GIẢM DẦN</option>
          </select>
      </div>
  </div>
            ...
            <div class="ps-shoe mb-30">
              ...
              <div class="ps-shoe__content">
                <div class="ps-shoe__variants">
                    ...
                    <button type="button" data-toggle="modal" data-target="#md_addcart_nike" value="<?php echo $value['id_product'] ?>" class="btn btn-danger btn-lg btn-block cart" >Thêm vào giỏ hàng</button>
...
<div class="ps-product-action">
  <div class="ps-pagination">
    <ul class="pagination">
      <li><a class="page-link" href="nike/<?php 
            if(isset($_GET['pages'])){
              $page = $_GET['pages'];
              if($page <= 1){
                echo $page;
      ...
      <?php  
        ...
        ?>
        <li <?php if (isset($_GET["pages"]) && $_GET["pages"] == $i) {echo 'class="active"';} ?>><a class="page-link" href="nike/<?php echo $i; ?>/<?php echo $method; ?>"><?php echo $i; ?></a></li>
        <?php
          }
        ?>
        <li><a href="nike/<?php 
